...
chrome_app <- read_csv("chrome_app_results_v034.csv")
...
benchmark_results <- read_csv("benchmark_results_v034.csv")
...
gtsave(gt_tbl, "chrome_app_benchmark_v034.pdf", zoom = 0.7)
gtsave(gt_tbl, "chrome_app_benchmark_v034.html", inline_css=TRUE)